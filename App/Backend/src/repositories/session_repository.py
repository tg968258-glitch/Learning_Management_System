...
class SessionRepository:
    @staticmethod
    def get_by_id(db: Session, session_id: int) -> ClassSession | None:
        return db.query(ClassSession).filter(ClassSession.session_id == session_id).first()

    @staticmethod
    def get_by_course(db: Session, course_id: int) -> list[ClassSession]:
        return (
    ...
    @staticmethod
    def create(db: Session, session_data: dict) -> ClassSession:
    ...
    @staticmethod
    def update(db: Session, session: ClassSession, update_data: dict) -> ClassSession:
